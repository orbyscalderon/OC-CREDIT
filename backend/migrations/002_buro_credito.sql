...
CREATE TYPE rol_sistema AS ENUM (
    'super_admin',        -- Plataforma OCA HOLDING GROUP LLC
    'admin_tenant',
    'supervisor_tenant',
    'cobrador_tenant'
);
...
-- ---------------------------------------------------------------------------
-- TABLA: super_admin_usuarios (Plataforma OCA HOLDING GROUP LLC)
...
COMMENT ON TABLE super_admin_usuarios IS
    'Administradores de la plataforma OCA HOLDING GROUP LLC. No pertenecen a ningún tenant.';
